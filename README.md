...
- A single onboard LED now blinks green while external power is charging the device
...
- Long-press Button C: runs the onboard audio hardware test
...
- Single-LED charge indicator works as a green charging blink, though plug/unplug response is delayed
